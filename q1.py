...
questions = [
    "What is the largest continent? _ _ _",
    "How many continents are in the world'? ___",
    "Where can you find the Amazon Rainforest and Andes? ___",
    "Which continent is the least populous? ___",
    "In Which continent you can find koalas and kangaroos",
    "Where can you find the Sahara Desert and the The Nile? ___",
]
...
choices = [
    ...
    ["Africa", "Australia", "Antarctica", "Europe"],
    ["Australia", "Asia", "Africa", "South America"],
    ["South America", "Europe", "North America", "Africa"],
]

correct_choices = [0, 2, 1, 2, 0, 3]


hints = [
    "This continent is home to more than half of the world's population.",
    "Don't forget to count America twice - once as North America and once as South America.",
    "Many cultures here where influenced by indigenous civilizations.",
    "This continent is mostly covered in ice.",
    "This continent is referred also as 'Land Down Under'.",
    "This continent has rich cultural heritage and many ethnic groups.",
]
...
score_label = tk.Label(root, text="Score: 0/6", font=("Arial", 18), bg="lightblue", fg="black", bd=2, relief=tk.SOLID)
